...
import { View, Text, TextInput, Button, StyleSheet, Alert,Keyboard,KeyboardAvoidingView, TouchableOpacity, Dimensions ,TouchableWithoutFeedback } from 'react-native';
